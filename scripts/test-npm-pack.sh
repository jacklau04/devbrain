...
check "Codex skills installed (\$continue)" '[ -f "$HOMEDIR/.agents/skills/continue/SKILL.md" ]'
check "Codex skills installed (\$distill)"  '[ -f "$HOMEDIR/.agents/skills/distill/SKILL.md" ]'
check "Codex skills installed (\$work)"     '[ -f "$HOMEDIR/.agents/skills/work/SKILL.md" ]'
